...
- **Task Files**: .blueprint-oss/specs/current/[dated specs folders]/tasks.md
- **Roadmap Files**: .blueprint-oss/roadmap.md
- **Tracking Docs**: .blueprint-oss/product/roadmap.md, .blueprint-oss/recaps/[dated recaps files]
...
- Create a dated recap file in .blueprint-oss/product/recaps/
